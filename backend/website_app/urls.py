...
urlpatterns = [
    ...
    path('my-duets/<int:pk>/video/', views.duet_generate_video, name='duet-generate-video'),
    path('my-duets/<int:pk>/video/status/', views.duet_video_status, name='duet-video-status'),
