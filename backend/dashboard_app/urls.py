...
urlpatterns = [
    ...
    path('songs/<int:pk>/credits/<int:credit_pk>/edit/', views.song_credit_edit, name='song-credit-edit'),
    path('songs/<int:pk>/credits/<int:credit_pk>/delete/', views.song_credit_delete, name='song-credit-delete'),
